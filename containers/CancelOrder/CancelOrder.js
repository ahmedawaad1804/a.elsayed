...
export default class CancelOrder extends React.Component {
  ...
  _send() {
    ...
    orderService.cancelOrders({id:this.props.navigation.state.params.orderID,cancelObject:{canceledBy:"client",message:this.state.Message}}).then(res => {
        ...
        <View style={[styles.container, { height: this.state.animeHeight }]}>
          ...
          <View style={styles.mainContainer}>
            ...
            <TouchableOpacity style={styles.tOpacity}
              ...
              onPress={() => this._send()}>
              <Text style={styles.text}>{I18nManager.isRTL ? "إلغاء" : "Cancel"}</Text>
